    ...
    public class Noticia : ICrud<Entidades.Noticia>
    {
        ...
        public List<Entidades.Noticia> Consultar(Entidades.Noticia entidade)
        {
            try
            {
                ...
                objDados.AdicionarParametros("@datDataCriacao", entidade.DataCriacao);
                ...
                foreach (DataRow objLinha in objDataTable.Rows)
                {
                    ...
                    objNovaNoticia.DataCriacao = objLinha["DataCriacao"] != DBNull.Value ? Convert.ToDateTime(objLinha["DataCriacao"]) : (DateTime?)null;
