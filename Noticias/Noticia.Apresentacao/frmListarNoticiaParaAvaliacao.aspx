<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmListarNoticiaParaAvaliacao.aspx.cs" Inherits="Noticia.Apresentacao.frmListarNoticiaParaAvaliacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Listar Notícias para Avaliação
    </h2>
            ...
            <asp:TemplateField HeaderText="Ações">
                <ItemTemplate>
                    ...
                    <asp:ImageButton runat="server" ID="ibtEditar" ImageUrl="~/Imagem/ico_habilitar.gif"
                        CommandArgument='<%# Eval("IdNoticia") %>' CommandName="AVALIAR" CausesValidation="False" ToolTip="Avaliar" />
